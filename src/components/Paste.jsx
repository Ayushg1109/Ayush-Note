          ...
          <div className="w-full px-4 pt-4 flex flex-col gap-y-5">  
            {filteredPastes.length > 0 ? (  
              filteredPastes.map((paste) => (  
                <div key={paste?._id} className="w-full flex flex-col sm:flex-row p-4 rounded bg-gray-700">  
                  ...
                  <div className="flex flex-col justify-between sm:items-end">  
                    <div className="flex gap-2 flex-wrap sm:flex-nowrap">  
                      <button className="p-2 rounded bg-gray-600 hover:bg-gray-500 transition duration-300">  
